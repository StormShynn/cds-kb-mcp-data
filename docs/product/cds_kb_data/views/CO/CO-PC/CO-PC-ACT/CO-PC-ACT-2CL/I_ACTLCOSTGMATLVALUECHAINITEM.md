...
| `FiscalYearPeriod` | ✓ | |  | `cast( concat($parameters.P_FiscalYear,$parameters.P_FiscalPeriod) as fins_fyearperiod )` | `NUMC(7)` | Fiscal Year + Fiscal Period |
...
| `MovementType` | ✓ | |  |  | `CHAR(3)` | Movement Type |
